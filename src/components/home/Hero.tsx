...
export function Hero({ onStartProject }: HeroProps) {
  return (
    <section className="relative isolate overflow-hidden bg-white pt-[4.5rem]">
      {/* Animation fills the full hero including the area under the fixed navbar */}
      <div className="pointer-events-none absolute inset-0 hidden lg:block">
        <HeroFlow variant="hero" className="h-full w-full" />
      </div>

      <div className="relative z-10 mx-auto max-w-7xl px-6 pb-10 pt-10 lg:px-16 lg:pb-14 lg:pt-14">
        ...
        <div className="mt-16 border-t border-[var(--border)]/80 pt-8 lg:mt-24">
          <p className="field-label mb-5">
            Trusted by
          </p>
          <div className="trusted-marquee relative -mx-6 overflow-hidden lg:-mx-16">
